 ...
 *┃➤* _${usedPrefix}Proveedor / Deseas Vender Violeti ?_
 *┃➤* _${usedPrefix}PinguiComu / Publicidad De La Comunidad Violeti_
 ...
 *┃➤* _${usedPrefix}minarVioleticoins | minarcoins_
 ...
 *┃➤* _${usedPrefix}añadircoins *@tag cantidad*_
  ╰━━━━━━━━━━━━━
`.trim()
await conn.sendFile(m.chat, gataImg.getRandom(), 'lp.jpg', menu, fkontak, false, { contextInfo: {mentionedJid, externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '𓍢ִ໋💜⊹ 𝗕𝗢𝗧 𝗩𝗜𝗢𝗟𝗘𝗧 𓍢ִ໋💜⊹', previewType: 0, thumbnail: imagen4, sourceUrl: redesMenu.getRandom()}}})
